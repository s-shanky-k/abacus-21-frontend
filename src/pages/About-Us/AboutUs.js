    ...
    render() {
        return (
            <>
                ...
                {/* Child Class */}
                <div ref={this.myRef} id="aboutus" className={`${styles._homepage} section sec1`} style={{ backgroundColor: '#060c21' }}>
                ...
                {/* Child Class */}
                <div className={`${styles._homepage} section sec2`} style={{ backgroundColor: '#060c21' }}>
                    <GlowCard props={{
                        title: "CSEA",
                ...
                {/* Child Class */}
                <div className={`${styles._homepage} section sec3`} style={{ backgroundColor: '#060c21' }}>
                    <GlowCard props={{
                        title: "CEG",
